...
const AboutUs = () => {
    ...
    return(
        <div>
            ...
            <p id = "text">ZeroX Domains aims to provide meaningful functions and integrations so you can utilize your domain to the max.
            </p>
            </div>
            ...
            <div className='footer'>
                ...
                <div id = "aboutus"><p onClick={routeChange} class = "home"> Home</p></div>
                <div id = "contactus">
                    Contact us&nbsp;&nbsp;&nbsp;
